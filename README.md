...
```
cd existing_repo
git remote add origin https://gitlab.com/ajaniljoshijobs/marketplace.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ajaniljoshijobs/marketplace/-/settings/integrations)
